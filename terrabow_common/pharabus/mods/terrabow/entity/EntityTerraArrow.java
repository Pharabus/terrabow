...
public class EntityTerraArrow extends Entity implements IProjectile{
	...
	public EntityTerraArrow( World world, EntityLivingBase shootingEntity, EntityLivingBase entityLiving2, float par4, float par5 ){
        super( world );
        this.renderDistanceWeight = 10.0D;
	...
	public EntityTerraArrow( World world, EntityLivingBase entityLiving, float par3 ){
        super( world );
        this.renderDistanceWeight = 10.0D;
	...
	public EntityTerraArrow( World world, EntityLivingBase entityLiving, float par3, float accuracyModifier, float durabilityRatio ){
        super( world );
