...
public class EntityTinArrow extends EntityTerraArrow{
	...
	public EntityTinArrow( World world, EntityLivingBase shootingEntity, EntityLivingBase entityLiving2, float par4, float par5 ){
		super( world, shootingEntity, entityLiving2, par4, par5 );
	}
	public EntityTinArrow( World world, EntityLivingBase entityLiving, float par3 ){
		super( world, entityLiving, par3 );
	}
	public EntityTinArrow( World world, EntityLivingBase entityLiving, float par3, float accuracyModifier, float durabilityRatio ){
    ...
    public ItemStack arrowheadDrop(){
    	return new ItemStack( ItemManager.Arrowhead, 1, 13 );
    }
}