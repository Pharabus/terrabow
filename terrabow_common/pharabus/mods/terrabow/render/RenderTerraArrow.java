package pharabus.mods.terrabow.render;
...
public class RenderTerraArrow extends Render{
	
	private String textureFile;
	
	public RenderTerraArrow( String textureFile ){
		this.textureFile = textureFile;
	}
	
	@Override
    protected ResourceLocation getEntityTexture(Entity entity) {
        return new ResourceLocation(this.textureFile);
    }
	
	public void doRender( Entity entity, double par2, double par4, double par6, float par8, float par9 ){
        this.renderArrow( (EntityTerraArrow) entity, par2, par4, par6, par8, par9);
    }
	public void renderArrow( EntityTerraArrow entityArrow, double par2, double par4, double par6, float par8, float par9 ){
        ...
        float var21 = (float)entityArrow.arrowShake - par9;
